...
{
	#region PluginInfo
	[PluginInfo(Name = "MQTT Sender", Category = "Network", Help = "Send Mqtt Messages.", Tags = "IoT, MQTT", Credits = "M2MQTT m2mqtt.wordpress.com",  Author = "Jochen Leinberger, explorative-environments.net", AutoEvaluate = true)]
